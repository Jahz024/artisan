    ...
    <AnimatePresence>
      {visible ? (
        <motion.div
          ...
          ref={setNodeRef}
          className={cn(
            "fixed bottom-6 left-1/2 z-40 flex -translate-x-1/2 items-center gap-3 rounded-2xl border px-8 py-4 shadow-lg",
            isOver
              ? "scale-105 border-red-400 bg-red-50"
        ...
        >
          ...
          >
            <Trash2 className={cn("h-6 w-6", isOver ? "text-red-600" : "text-red-400")} />
          </motion.div>
