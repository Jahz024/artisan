...
export const DEMO_PRESETS: DemoPreset[] = [
  { id: "cs-freshman", label: "CS Freshman", emoji: "💻", description: "Started Fall 2025, AP Calc credit", major: "Computer Science", year: "freshman", targetGrad: { year: 2029, termType: "spring", label: "Spring 2029" } },
  { id: "cs-sophomore", label: "CS Sophomore", emoji: "📚", description: "Started Fall 2025, finished core math & intro CS", major: "Computer Science", year: "sophomore", targetGrad: { year: 2029, termType: "spring", label: "Spring 2029" } },
  { id: "cs-junior", label: "CS Junior", emoji: "🎓", description: "Started Fall 2024, deep in systems & algorithms", major: "Computer Science", year: "junior", targetGrad: { year: 2028, termType: "spring", label: "Spring 2028" } },
  { id: "cyber-sophomore", label: "Cybersecurity Soph", emoji: "🔐", description: "Started Fall 2025, security-focused", major: "Computer Science — Secure Computing", year: "sophomore", targetGrad: { year: 2029, termType: "spring", label: "Spring 2029" } },
  { id: "ds-junior", label: "Data Science Junior", emoji: "📊", description: "Started Fall 2024, stats + ML track", major: "Computer Science — Data Analytics", year: "junior", targetGrad: { year: 2028, termType: "spring", label: "Spring 2028" } },
  { id: "eng-freshman", label: "Gen. Engineering", emoji: "⚙️", description: "Started Fall 2025, physics heavy", major: "General Engineering", year: "freshman", targetGrad: { year: 2029, termType: "spring", label: "Spring 2029" } },
];
...
function buildDemoCSSoph(): TranscriptParseResult {
  ...
  return {
    completedCourses: [
      ...
      termCourse("ENGE", "1215", "A", 2, "Spring 2026"),
      termCourse("PSYC", "2004", "A-", 3, "Spring 2026"),
    ],
    inProgressCourses: ["CS-2505", "MATH-2534", "STAT-4705"],
    major: p.major,
    minors: [],
...
function buildDemoCSJunior(): TranscriptParseResult {
  ...
  return {
    ...
    inProgressCourses: ["CS-3214", "CS-3304", "STAT-4706"],
    major: p.major,
    minors: [],
...
function buildDemoEngFreshman(): TranscriptParseResult {
  ...
  return {
    completedCourses: [
      ...
      termCourse("MATH", "1225", "A-", 4, "Fall 2025"),
      termCourse("PHYS", "2305", "B+", 4, "Fall 2025"),
      termCourse("ENGL", "1105", "B", 3, "Fall 2025"),
      termCourse("ENGE", "1024", "A", 2, "Fall 2025"),
      termCourse("CHEM", "1035", "B+", 3, "Fall 2025"),
      termCourse("CHEM", "1045", "A", 1, "Fall 2025"),
      // Spring 2026 — 16cr
      termCourse("MATH", "1226", "B+", 4, "Spring 2026"),
      termCourse("CS", "1114", "A-", 3, "Spring 2026"),
      termCourse("ENGL", "1106", "B", 3, "Spring 2026"),
      termCourse("PHYS", "2306", "B", 4, "Spring 2026"),
      termCourse("ENGE", "1215", "A", 2, "Spring 2026"),
    ],
    inProgressCourses: ["MATH-2114", "CS-2114", "COMM-1016"],
    major: p.major,
    minors: [],
    catalogYear: "2025-2026",
    usedDemoFallback: true,
